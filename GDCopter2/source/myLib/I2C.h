...
typedef struct I2C_OpDescript_Type //нужно перенести байты в OperationDescription, чтоб I2C знал, что писать, аллоцирую массив с байтами, передаю в startoperation, он сам его удаляет
{
