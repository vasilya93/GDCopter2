...
{
  char* (*GetNextInitOperation)(uint16_t currentDataDescript, I2C_OpDescript_Type* opDescript);
  char* (*GetNextRegOperation)(uint16_t currentDataDescript, I2C_OpDescript_Type* opDescript);
