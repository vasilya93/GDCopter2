...
public:
	...
	//Access functions
	unsigned long GetBytesRead(){return _bytesRead;}
	char* GetReadBuf(){return _readBuf;}

	void SetReadFile(wchar_t* readFile){_readFileName = readFile; _readOffset = 0;}
	void SetWriteFile(wchar_t* writeFile){_writeFileName = writeFile;}
